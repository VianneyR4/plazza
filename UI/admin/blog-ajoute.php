                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="active"><a title="blog-ajoute" href="blog-ajoute.php"><span class="mini-sub-pro"> | Ajouté</span></a></li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demolibra">Temoignege <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ajouté une article</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="blog-ajoute.php" enctype="multipart/form-data" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="bloger" type="text" class="form-control" placeholder="Nom du blogeur." required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <select name="gender" class="form-control">
                                                                        <option value="none" selected="" disabled="">Selectionner le genre de l'article</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="title" type="text" class="form-control" placeholder="Titre de l'article." required>
                                                                </div>
                                                                <div class="form-group alert-up-pd">
                                                                    <input name='blog_files[]' type="file" class="form-control" id="multi_media" style="padding: 81px 15px !important;border: 2px dashed #ccc;" required/>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group res-mg-t-15" id="article">
                                                                    <textarea name="article" placeholder="Article" id="text_area" required></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
