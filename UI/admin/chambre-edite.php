<?php
    ...
    session_start();
    include_once('../../Server Side/admin_edite_room.php');   
    ...
    <body>
                        ...
                        <ul class="metismenu" id="menu1">
                            ...
                            <li class="active">
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    ...
                                    <li class="active"><a title="chambre-edite" href="chambre-edite.php"><span class="mini-sub-pro"> | Edité</span></a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="booking.php">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="breadcome-heading">
                                                <form role="seach" class="sr-input-func" action="chambre-edite.php">
                                                    <input type="text" name="room_to_edite" placeholder="Recherche..." value="<?php if(isset($_GET['room_to_edite'])){echo $_GET['room_to_edite'];} ?>" class="search-int form-control" required>
                                                    <a name="search">
        ...
        <?php 
            if (!empty($uploaded)){
                ...
                <div class="server-message bg-success">
                    <span>MIS A JOUR REUSSI: </span> chambre numero <small>'.$_POST['numero'].'</small> + ';
                    $i=0;
                    foreach ($uploaded as $failed_content){
                        $i=$i+1;
                }
                echo '<small>'.$i.'</small> Fichiers images ajouté</div> ';
        ...
        <?php
            if (isset($_POST['search'])){
                $myID = $_POST['value_to_search'];
            } else if (isset($_GET['room_to_edite'])) {
                $myID = $_GET['room_to_edite'];
            } else {
                echo '
                <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
                <center><h2><i class="fa fa-search"></i> Recherchez une chambre a editer par ID!</h2></center>
                <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
                ';
            }

            if (isset($myID)){
                $query_rdte = $db->prepare('SELECT * FROM chambres WHERE ID=:ID');
                $query_rdte->execute(array(
                    'ID' => $myID
                ));
                foreach($query_rdte as $rdte) {
                    ?>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="product-payment-inner-st">
                                        <ul id="myTabedu1" class="tab-review-design">
                                            <li class="active"><a href="#description">ID: <?php echo $rdte['ID'].' | Chambre '.$rdte['numero']; ?></a></li>
                                        </ul>
                                                        ...
                                                        <div class="review-content-section">
                                                            ...
                                                            <form action="" enctype="multipart/form-data" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="form-group">
                                                                                <select name="type" class="form-control" required>
                                                                                    <?php
                                                                                        if ($rdte['type'] == 'Normale'){
                                                                                            echo '<option value="Normale">Chambre Normale</option>';
                                                                                            echo '<option value="Speciale">Chambre Speciale</option>';
                                                                                        }
                                                                                        else if ($rdte['type'] == 'Speciale'){
                                                                                            echo '<option value="Speciale">Chambre Speciale</option>';
                                                                                            echo '<option value="Normale">Chambre Normale</option>';
                                                                                        }
                                                                                        else if ($rdte['type'] == 'Special'){
                                                                                            echo '<option value="Speciale">Chambre Speciale</option>';
                                                                                            echo '<option value="Normale">Chambre Normale</option>';
                                                                                        }
                                                                                    ?>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input name="numero" type="number" class="form-control" value="<?php echo $rdte['numero']; ?>" placeholder="Chambre num." required>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <select name="standard" class="form-control" required>
                                                                                    <?php
                                                                                        echo '<option value="'.$rdte['standard'].'">'.$rdte['standard'].'</option>';
                                                                                    ?>
                                                                                    <option value="Single chambre de luxe">Single chambre de luxe</option>
                                                                                    <option value="Double chambre de luxe">Double chambre de luxe</option>
                                                                                    <option value="Economique double">Economique double</option>
                                                                                    <option value="Single chambre">Single chambre</option>
                                                                                    <option value="Double chambre">Double chambre</option>
                                                                                </select>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="form-group">
                                                                                <select name="stars" class="form-control" required>
                                                                                    <?php
                                                                                        echo '<option value="'.$rdte['stars'].'">'.$rdte['stars'].'</option>';
                                                                                    ?>
                                                                            ...
                                                                            <div class="form-group res-mg-t-15">
                                                                                <textarea name="description" placeholder="Description" id="text_area" required><?php echo $rdte['description']; ?></textarea>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <select name="wifi" class="form-control" required>
                                                                                    <?php
                                                                                        echo '<option value="'.$rdte['wifi'].'">'.$rdte['wifi'].'</option>';
                                                                                    ?>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <select name="tv" class="form-control" required>
                                                                                    <?php
                                                                                        echo '<option value="'.$rdte['tv'].'">'.$rdte['tv'].'</option>';
                                                                                    ?>
                                                                                    <option value="Yes">Yes</option>
                                                                                    <option value="No">No</option>
                                                                                </select>
                                                                            ...
                                                                            <div class="form-group">
                                                                                <input name="prix" type="number" class="form-control" value="<?php echo $rdte['prix']; ?>" placeholder="Prix/nuit" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="payment-adress">
                                                                                <button type="submit" name="edite_room" class="btn btn-primary waves-effect waves-light">Actualisé la chambre</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                                ...
                                                                <div class="box-des-images">
                                                                    <div class="row">
                                                                        <?php
                                                                            $query_select_room_img = $db->prepare('SELECT * FROM chambre_img WHERE chambre_num=:c_num ORDER BY ID DESC');
                                                                            ...
                                                                            foreach($query_select_room_img as $data_img){
                                                                                ...
                                                                                <div class="admin-img-box col-md-4 col-sm-6">
                                                                                    <img src="../uploads/rooms/<?php echo $data_img['img_name']; ?>" style="border-radius: 2px;" />
                                                                                    <a href="../../Server Side/delete-room.php?img_id=<?php echo $data_img['ID'] ?>&room_from_img_id=<?php echo $rdte['ID'] ?>" style="position: absolute;
                                                                                                                                                                                                                        top: -20px;
                                                                                                                                                                                                                        right: 0;
                                                                                                                                                                                                                        background: none;
                                                                                                                                                                                                                        border: none;
                ...
                if (empty($rdte)){
                    echo '
                    <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
                    <center><h2><i class="fa fa-search"></i> Resultat de la recherche chambre ID: '.$_GET['room_to_edite'].' n\'est pas trouvé!</h2></center>
                    <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
                    ';
                }
            }
