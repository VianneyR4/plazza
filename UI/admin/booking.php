            ...
            <div class="library-book-area mg-t-30" id="myTable">
                <table id="t01">
                    ...
                    <?php
                        ...
                        $counterBooking = 0; 
                        $query_select_rooms = $db->prepare('SELECT * FROM booking ORDER BY ID DESC');
                        $query_select_rooms->execute();
                        foreach ($query_select_rooms as $ard){
                            ...
                            <tr>
                                ...
                                <td>'.$ard['entre'].'</td>
                                <td>'.$ard['sortie'].'</td>
                                <td>'.$ard['numChambre'].'</td>
                                <td>'.$ard['phone'].'</td>
                                <td>'.$ard['mail'].'</td>
                                <td>'.$ard['date_booking'].'</td>
                                <td>'.$ard['pu'].'$</td>
                                <td>'.$ard['prix'].'$</td>
                                <td id="td_center">
                                    ';
                                    if ($ard['confirmation'] == 'yes'){
                                    ...
                                    else if ($ard['confirmation'] == 'rejected'){
                                        $verif_rejected = 'created';
                                        echo '<span class="ion-android-cancel" style="color: red;font-size: 20px;"></span>';
                                    }
                                    else {
                                        echo '<a href="../../Server Side/delete-room.php?id_to_confirm='.$ard['ID'].'&&numChambre='.$ard['numChambre'].'"><span class="ion-alert-circled" style="color: #777777;font-size: 20px;"></span></a>';
                                    }
                                    echo '
                                </td>
                            </tr>
                    ...
                    <tr>
                        <th></th>
                        <th><?php echo $counterConfirmation.'/'.$counterBooking ?> confirmer</th>
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
                        ...
                        <th>
                            <?php 
                                if (isset($verif_rejected)){
                                    echo '<a href="../../Server Side/delete-room.php?to_reject='.$verif_rejected.'" style="cursor: pointer;">Rejeter(<span class="ion-android-cancel" style="color: red;font-size: 11px;"></span>)</a>';
                                }
                            ?>
                        </th>
                    </tr>
