<?php
    ...
    // Add images into galerie ...
	if (isset($_POST['upload_to_galerie'])){
		#code...
					 ...
					 #code..
						if ($file_error === 0){
							...
							if ($file_size <= 2097152){
								#code..
								$file_name_new = uniqid('Plazza-IMG-Galerie-', true) . '.'  . $file_ext;
								$file_destination = '../uploads/galerie/' . $file_name_new;

								if (move_uploaded_file($file_tmp, $file_destination)){
									#code...
									$uploaded[$position] = $file_destination;
									
									$query_upload_img_room = $db->prepare('INSERT INTO galerie(img_name,img_type,img_size) VALUES(:img_name,:img_type,:img_size)');
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="active"><a title="galerie-ajoute" href="galerie-ajoute.php"><span class="mini-sub-pro"> | Ajouté</span></a></li>
                            </ul>
                        </li>
                        <li>
        ...
        <?php 
            if (!empty($uploaded)){
                ...
                <div class="server-message bg-success">
                    <span>TELECHARGEMENT REUSSI: </span> ';
                    $i=0;
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ajouté des image</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    ...
                                                    <form action="galerie-ajoute.php" enctype="multipart/form-data" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="payment-adress">
                                                                    <button type="submit" name="upload_to_galerie" class="btn btn-primary waves-effect waves-light">Ajouté</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
