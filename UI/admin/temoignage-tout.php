                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li class="active"><a title="temoignage-tout" href="temoignage-tout.php"><span class="mini-sub-pro"> | Toute</span></a></li>
        ...
        <div class="library-book-area mg-t-30" id="myTable">
            <table id="t01">
                ...
                <?php
                        $type1 = 'Speciale';
                        $type2 = 'Normale';
                        $query_select_rooms = $db->prepare('SELECT * FROM temoignage ORDER BY ID DESC');
                        ...
                        foreach ($query_select_rooms as $ard){
                            ...
                            <tr>
                                ...
                                <td id="td_center">
                                    <a href="../../Server Side/delete-room.php?temoignage_id='.$ard['ID'].'">
