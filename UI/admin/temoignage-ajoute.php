                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li class="active"><a title="temoignage-ajoute" href="temoignage-ajoute.php"><span class="mini-sub-pro"> | Ajouté</span></a></li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        ...
                                                        <span class="admin-name">Admin Dominic</span>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ajouté un temoignage</a></li>
                            </ul>
                                                ...
                                                <div id="dropzone1" class="pro-ad">
                                                    <?php
                                                        if (isset($_POST['poster'])){
                                                            #code...
                                                            $query_upload_room = $db->prepare('INSERT INTO temoignage(name,article,stars) VALUES(:name,:article,:stars)');
                                                            $query_upload_room->execute(array(
                                                                'name' => $_POST['name'],
                                                                'article' => $_POST['temoignge'],
                                                                'stars' => $_POST['etoiles']
                                                            ));
                                                            $uploaded = 'okay';
                                                        }
                                                    ...
                                                    <?php 
                                                        if (isset($uploaded)){
                                                            ...
                                                            <div class="server-message bg-success">
                                                                <span>POST REUSSI: </span> Nom du client <small>'.$_POST['name'].'</small> 
                                                            </div> ';
                                                        }
                                                    ?>                      
                                                    <!-- message End-->
                                                    <form action="temoignage-ajoute.php" method="POST"  class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="name" type="text" class="form-control" placeholder="Nom du temoin.">
                                                                </div>
                                                                <div class="form-group">
                                                                    <select name="etoiles" class="form-control">
                                                                        <option value="none" selected="" disabled="">Selectionner le nombre d'etoile</option>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group res-mg-t-15" id="temoignage">
                                                                    <textarea name="temoignge" placeholder="Temoignage" id="text_area"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="payment-adress">
                                                                    <button type="submit" name="poster" class="btn btn-primary waves-effect waves-light">
                                                                        Posté 
