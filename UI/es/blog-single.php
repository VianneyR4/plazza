<?php
    ...
    $query_fb = $db->prepare('SELECT * FROM blog WHERE ID=:ID');
    $query_fb->execute(array(
        'ID' => $_GET['id']
    ));
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <img class="img-fluid" src="../uploads/blog/<?php echo $uData_fb['image']; ?>" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single-sidebar-widget newsletter_widget">
                            ...
                            <p>
                                Subscrib for more information about La Joie Plazza Hotel.
                            </p>
