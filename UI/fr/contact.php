...
<body>
    ...
    <section class="contact_area section_gap">
        <div class="container">
            <div id="mapBox()" class="mapBox" data-lat="40.701083" data-lon="-74.1522848" data-zoom="13" data-info="PO Box Goma, Nord-Kivu, RDC" data-mlat="40.701083" data-mlon="-74.1522848">
            </div>
            <div class="row">
                <div class="col-md-3">
                    <div class="contact_info">
                        <div class="info_item">
                            ...
                            <h6>Goma, Nord-kivu, Congo-kinshasa</h6>
                            <p>Av. BUNAGANA</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-phone-handset"></i>
                            <h6><a href="#">+(243) 812082665,<br/>+(243) 994326446</a></h6>
                            <p>Lun au Ven de 9h a 18h</p>
                        </div>
                        <div class="info_item">
                            <i class="lnr lnr-envelope"></i>
                            <h6><a href="#">info@lajoieplazza.com</a></h6>
                ...
                <div class="col-md-9">
                    ...
                    <form class="row contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="col-md-12 text-right">
                            <button type="submit" value="submit" class="btn theme_btn button_hover">Envoyer le Message</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2>Merci!</h2>
                    <p>Votre message a etait envoyer avec succé...</p>
                </div>
            </div>
        </div>
    </div>
