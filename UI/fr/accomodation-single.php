        ...
        <div class="container">
            <div class="page-cover text-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="accomodation.php">Logement</a></li>
                    <li class="active">Logement-Specifique</li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <section class="accomodation_area section_gap">
                <div class="container">
                    <div class="section_title text-center">
                        <h2 class="title_color">Hébergement <?php echo $uData_room['type']; ?></h2>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="book_tabel_item">
                                                            <div class="input-group">
                                                                <input type='number' name="bookingNumber" class="form-control" placeholder="Numero de telephone" required style="border-radius: 0px;background-color:#0b1803;border: 1px solid #2b3146;outline:none;font-size:13px;" />
                                                            </div>
                                                            <div class="input-group">
                                                        ...
                                                        <div class="book_tabel_item">
                                                            <div class="input-group">
                                                                <select class="wide" name="bookingRoom" required>
                                                                        <option data-display="Chambre numero <?php echo $uData_room['numero']; ?>" value="<?php echo $uData_room['numero']; ?>">Chambre numero <?php echo $uData_room['numero']; ?></option>
