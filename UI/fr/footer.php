            ...
            <div class="row">
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        <h6 class="footer_title">ADRESSE DE L'HOTEL</h6>
                        <p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        <h6 class="footer_title">LIENS DE NAVIGATION</h6>
                        <div class="row">
                            <div class="col-4">
                                <ul class="list_style">
                            ...
                            <div class="col-4">
                                <ul class="list_style">
                                    ...
                                    <li><a href="../en/index.php">Anglais</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        <h6 class="footer_title">Abonnéz-Vous</h6>
                        <p>Abonnéz-Vous pour etre informer en temps réel de nos nouveauté</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget instafeed">
                        <h6 class="footer_title">Galerie</h6>
